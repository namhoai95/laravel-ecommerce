                            ...
                            @foreach($category as $item)
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="{{ action('CategoryController@show', ['namealias' => $item->ten_alias]) }}">{{ $item->ten_loai }}</a></h4>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    @foreach($manufacturer as $item)
                                        <li><a href="{{ action('ManufacturerController@show', ['nanealias' => $item->ten_alias]) }}"> <span class="pull-right"></span>{{ $item->ten_thuong_hieu }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div><!--/brands_products-->
